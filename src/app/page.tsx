      ...
      <div className="flex flex-col flex-wrap justify-center items-center min-h-dvh">
        <div className="w-11/12 max-w-96">
          <div className="border border-foreground rounded-lg p-6 bg-gray-100">
            ...
            <button
              type="button"
              className="flex items-center justify-center mt-6 w-full h-12 rounded-full border-2 border-black text-neutral-800 bg-stone-50 hover:bg-stone-200 transition-colors duration-300"
            >
              <Mic />
            </button>
          </div>
          <div className="bg-foreground h-11 rounded-md mt-4 flex items-center gap-4 px-7">
